...
if(isset($_POST['username']) & isset($_POST['password']) & !empty($_POST['username']) & !empty($_POST['password'])){
    ...
    if($admin->createSuper()){
        echo json_encode(array('msg'=>'Super Admin created', 'status'=>true));
    }else{
        echo json_encode(array('msg'=>'Failed to create super admin account. Try again'));
    }
}else{
